...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \textbf{URL cím alapján eljutni másik oldalra sikeres bejelentkezés nélkül:} Ebben az esetben egy hibaüzenet jelenik meg egy linkkel a bejelentkezési oldalra.
	\end{itemize}
	\item Főoldal:
\end{enumerate}