...
class Task(models.Model):
    ...
    assignee = models.ForeignKey("users.Profile", on_delete=models.SET_NULL, related_name="task_assignee", null=True)
    ...
    epic = models.ForeignKey("epics.Epic", on_delete=models.CASCADE, related_name="task_epic", null=True)
